    ...
    return(
            <View style={parcelModalStyle.container}>
                <View style={parcelModalStyle.first}>
                    ...
                    <Text style={parcelModalStyle.left_text}>Parcel Selected Succesfully</Text>
                </View>
                ...
                <View>
                    <TouchableOpacity style={parcelModalStyle.buttonStyle} onPress={onPress}>
                        <Text style={parcelModalStyle.buttonText}>Reserve Parcel</Text>
                    </TouchableOpacity>
                </View>
            </View>
    );
...
export default ParcelSelectedModal;